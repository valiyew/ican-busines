  ...
  <div class="icanBusines">
    <div class="bg">
      <div class="title" style="transition: 0.5s" v-motion-slide-visible-once-top>
        ...
        <p class="aboutText">
          Наш сайт обеспечивает безопасное хранение и эффективное управление инвентаре😊.
          <br />
          <br />
          Воспользуйтесь нашими инновационными решениями для максимальной защиты товаров и данных
          ⚡.
        </p>
