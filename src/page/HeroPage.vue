<template>
  <div class="hero">
    ...
    <div class="about">
      <div class="title">
        <div>
          <h1>Автоматизация процессов рассрочки с помощью готовых решений</h1>
          <p>
            ICan Business представляет высокозащищенную и надежную платформу, для бизнеса рассрочки
            товаров и услуг.
          </p>
        </div>
        <div class="buttons">
