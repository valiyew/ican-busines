<template>
  <div class="modal">
    <div class="modal-content container">
      ...
      <div class="about">
        <h1>
          <span>Оставьте свой контакт, и мы свяжемся с вами:</span>
          <img class="check" src="../assets/images/check.svg" alt="" />
        </h1>
        <div class="absaluteBox">С нами удобнее работать</div>
      </div>
...
const handleChange = async () => {
  try {
    ...
    toast.success('Your information has been successfully sent and we will contact you shortly')
